...
class EventFSDJump(JournalEvent):
    def __init__(self, event):
        ...
        self.star_system = StarSystem(event.get('StarSystem'), event.get('StarPos')) # LINK TO EVENTSTARTJUMP
...
class EventStartJump(JournalEvent):
    def __init__(self, event):
        ...
        self.star_system = StarSystem(event.get('StarSystem'), self.star_class) # LINK TO EVENTFSDJUMP
